...
QuestionnaireData<-read.csv(GitHub_data)
names(QuestionnaireData)<-c("Consent","Age","Work_Location","Sex","Occupation","Other","Academic?","PhD","Postdoc","Assistant_Lecturer","Lecturer","Senior_Lecturer","Reader","Professor","Trainee_Prac_Psych","Prac_Psych","Other","Left_Academia?","Stress","W_L_balance","Truth_of_field","Criticism_culture","Bullying","Pay","Criticised","Replics","Incentives","No_benefit","No_progress","Location","Funding","Other","Comments")
PCAset<-data.frame(QuestionnaireData$Stress, QuestionnaireData$W_L_balance, QuestionnaireData$Truth_of_field, QuestionnaireData$Criticism_culture, QuestionnaireData$Bullying, QuestionnaireData$Pay, QuestionnaireData$Criticised, QuestionnaireData$Replics, QuestionnaireData$Incentives, QuestionnaireData$No_benefit, QuestionnaireData$No_progress, QuestionnaireData$Location, QuestionnaireData$Funding)
PCA<-prcomp(PCAset, scale = FALSE)
plot(PCA, type = "l")
summary(PCA)